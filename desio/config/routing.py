...
def make_map(config):
    ...
    map.connect('/file/delete/{id}', controller='organization/file', action='delete', conditions=has_subdomain)
    map.connect('/file/change/{change}', controller='organization/file', action='change', conditions=has_subdomain)
